...
R is a scripting language while RStudio is a GUI that uses R. Github is a file storage and management website that allows programmers to upload their files to the public.
