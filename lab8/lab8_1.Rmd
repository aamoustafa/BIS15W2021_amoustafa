...
Column names themselves are data. 
...
Column name represents data. "day" included. 
...
Untidy because 2 different variables represented in the column names. Experiment 1, replicate 1. Then experiment 2 replicate 3, etc. etc. 
...
qpcr_untidy %>% 
  pivot_longer(
    ...
    names_sep="_", #pull apart experiment and replicate at _
